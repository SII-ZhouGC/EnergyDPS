...
def convert_olmo2_weights(olmo2: Olmo2ForCausalLM, cfg: HookedTransformerConfig):
    ...
    for l in range(cfg.n_layers):
        ...
        state_dict[f"blocks.{l}.attn.ln_q.w"] = einops.rearrange(olmo2_layer.self_attn.q_norm.weight, "(h d)->h d", h=cfg.n_heads, d=cfg.d_head)
        state_dict[f"blocks.{l}.attn.ln_k.w"] = einops.rearrange(olmo2_layer.self_attn.k_norm.weight, "(h d)->h d", h=cfg.n_heads, d=cfg.d_head)
