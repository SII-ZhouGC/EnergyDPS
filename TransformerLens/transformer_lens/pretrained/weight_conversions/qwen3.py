...
def convert_qwen3_weights(qwen, cfg: HookedTransformerConfig):
    ...
    for l in range(cfg.n_layers):
        ...
        state_dict[f"blocks.{l}.attn.ln_q.w"] = qwen.model.layers[l].self_attn.q_norm.weight.expand(cfg.n_heads, -1)
        state_dict[f"blocks.{l}.attn.ln_k.w"] = qwen.model.layers[l].self_attn.k_norm.weight.expand(cfg.n_key_value_heads, -1)
